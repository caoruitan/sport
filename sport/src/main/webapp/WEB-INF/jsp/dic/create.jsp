...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="editBox">
			<form id="dic-create-form">
				<table class="editTable">
					<tr>
						<th class="required">分类</th>
						<td>
							<input name="typeName" type="text" value="${dic.name }" readonly="readonly"/>
							<input type="hidden" name="pCode" value="${dic.code}" id="pCode"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th>描述</th>
						<td><textarea name="description" value="" style="width:500px;"></textarea></td>
					</tr>
				</table>
			</form>
			<p class="save-btn">
				<button class="btn-red btn-size-big sport-dic-create-btn">保存</button>
