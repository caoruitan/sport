...
<body>
	...
	<script type="text/javascript">
		...
		$("#e-xbfjf").click(function(){
			showLayout('b-xbfjf');
			$(".b-xbfjf").load("<%=basePath%>/subject/appropriation/kjsadmin/list.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
		$("#e-jfys").click(function(){
			showLayout('b-jfys');
			$(".b-jfys").load("<%=basePath%>/subject/rwsbudget/kjsadmin/cost.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
	</script>
</body>
