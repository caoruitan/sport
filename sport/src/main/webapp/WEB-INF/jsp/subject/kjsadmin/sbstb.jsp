	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#e-sqrqk").click(function(){
				showLayout('b-sqrqk');
				$(".sqrqk-container").load("<%=basePath%>/subject/proposer/kjsadmin/list.htm?sbsId=${sbs.sbsId}&subjectId=${subjectId}");
			});
			
			$("#e-jfys").click(function(){
				showLayout('b-jfys');
				$(".jfys-container").load("<%=basePath%>/subject/sbsbudget/kjsadmin/cost.htm?sbsId=${sbs.sbsId}&subjectId=${subjectId}");
			});
		});
	</script>
</body>
