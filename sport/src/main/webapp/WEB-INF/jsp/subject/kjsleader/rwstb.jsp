...
<body>
	...
	<script type="text/javascript">
		...
		$("#e-jdap").click(function(){
			showLayout('b-jdap');
			$(".b-jdap").load("<%=basePath%>/subject/schedule/kjsleader/list.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
		
		$("#e-sbgzmx").click(function(){
			showLayout('b-sbgzmx');
			$(".b-sbgzmx").load("<%=basePath%>/subject/device/kjsleader/list.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
		
		$("#e-xbfjf").click(function(){
			showLayout('b-xbfjf');
			$(".b-xbfjf").load("<%=basePath%>/subject/appropriation/kjsleader/list.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
		$("#e-jfys").click(function(){
			showLayout('b-jfys');
			$(".b-jfys").load("<%=basePath%>/subject/rwsbudget/kjsleader/cost.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
	</script>
</body>
