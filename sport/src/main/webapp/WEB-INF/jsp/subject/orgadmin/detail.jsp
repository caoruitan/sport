...
<body>
	...
	<div class="titleBox">
		...
		<a href="<%=basePath %>/subject/orgadmin/list.htm">
				...
				<div class="line">
						...
						<li class="cur">
							...
							<p>
								<c:if test='${not empty sbs}'>
									<a href="<%=basePath %>/subject/orgadmin/sbstb.shtm?subjectId=${subject.id}" target="_blank">
					...
					<c:if test='${subject.stage eq "RWSTB"}'>
						<li class="ok">
							<p><b>申报书填报与评审</b></p>
							<p>截止 <fmt:formatDate value="${subject.sbsEndDate}" type="date"/></p>
							<p><a href="<%=basePath %>/subject/orgadmin/sbstb.shtm?subjectId=${subject.id}" target="_blank"><button class="btn-red btn-size-small">查看</button></a></p>
						</li>
						<li class="cur">
							<p><b>任务书填报与评审</b></p>
							<p>截止 <fmt:formatDate value="${subject.rwsEndDate}" type="date"/></p>
							<p>
								<c:if test='${not empty rws}'>
									<a href="<%=basePath %>/subject/orgadmin/rwstb.shtm?subjectId=${subject.id}" target="_blank">
						...
						<li class="cur">
							...
							<p>
								<c:if test='${not empty sc}'>
									<a href="<%=basePath %>/subject/orgadmin/conclusiontb.shtm?subjectId=${subject.id}" target="_blank">
