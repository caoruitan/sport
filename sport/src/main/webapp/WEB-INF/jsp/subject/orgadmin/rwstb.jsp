	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#tj').dialog({
				...
				ok: function() {
					$.ajax({
						url: "<%=basePath%>/subject/orgadmin/rwsPass.action",
						type: "POST",
						dataType: "JSON",
						data: {
							subjectId : "${subjectId}",
			...
			$('#th').dialog({
				...
				ok: function() {
					$.ajax({
						url: "<%=basePath%>/subject/orgadmin/rwsUnpass.action",
						type: "POST",
						dataType: "JSON",
						data: {
							subjectId : "${subjectId}",
		...
		$("#e-jfys").click(function(){
			showLayout('b-jfys');
			$(".b-jfys").load("<%=basePath%>/subject/rwsbudget/orgadmin/cost.htm?rwsId=${rws.rwsId}&subjectId=${subjectId}");
		});
	</script>
</body>
