	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#tj').dialog({
				...
				ok: function() {
					$.ajax({
						url: "<%=basePath%>/subject/orgoper/pass.action",
						type: "POST",
						dataType: "JSON",
						data: {
							subjectId : "${subjectId}",
			...
			$('#th').dialog({
				...
				ok: function() {
					$.ajax({
						url: "<%=basePath%>/subject/orgoper/unpass.action",
						type: "POST",
						dataType: "JSON",
						data: {
							subjectId : "${subjectId}",
			...
			$("#e-sqrqk").click(function(){
				showLayout('b-sqrqk');
				$(".sqrqk-container").load("<%=basePath%>/subject/proposer/orgoper/list.htm?sbsId=${sbs.sbsId}&subjectId=${subjectId}");
			});
			
			$("#e-jfys").click(function(){
				showLayout('b-jfys');
				$(".jfys-container").load("<%=basePath%>/subject/sbsbudget/orgoper/cost.htm?sbsId=${sbs.sbsId}&subjectId=${subjectId}");
			});
		});
	</script>
</body>
