...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#e-xtyj").click(function(){
			...
			$(".xtyj-container").load("<%=basePath%>/word/open",{fileId:"rws${subjectId}${subject.creator}_01.doc",title:"一到六项文档性内容填报",_csrf:$("#csrfToken").val(),readonly:true});
		});
		...
		$("#e-ysly").click(function(){
			showLayout('b-ysly');
			$(".sport-container").children().remove();
			$(".ysly-container").load("<%=basePath%>/word/open",{fileId:"rws${subjectId}${subject.creator}_11.doc",title:"11 预算来源及经费支出情况说明",_csrf:$("#csrfToken").val(),readonly:true});
		});
